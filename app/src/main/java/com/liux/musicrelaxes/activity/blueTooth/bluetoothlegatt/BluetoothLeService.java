...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_DATA_HEART_RATE =
            "com.example.bluetooth.le.EXTRA_DATA_HEART_RATE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        //BLE设备的特性发生改变，就会触发onCharacteristicChanged()回调
        @Override
    ...
    /**
     * 设备连接成功后 开始发送广播，根据特定的action，调用对应的方法实现这个动作
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if ((flag & 0x01) != 0) {
                ...
                Log.d(TAG, "Heart rate format UINT16."); //2字节 uint16_t
            } else {
...
//            intent.putExtra(EXTRA_DATA_HEART_RATE,new String(data));
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        //再新开一个BluetoothGattDescriptro将相关的UUID跟参数塞进去，这样才能触发onCharacteristicGhanged()
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
